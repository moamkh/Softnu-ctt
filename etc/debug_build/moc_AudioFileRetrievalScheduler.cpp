/****************************************************************************
** Meta object code from reading C++ file 'AudioFileRetrievalScheduler.h'
**
...
#include <memory>
#include "../../src/services/CppAmi/core/AudioFileRetrievalScheduler.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'AudioFileRetrievalScheduler.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 15, 13), // "startNightJob"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 12) // "stopNightJob"

    },
    "RequestManager\0startNightJob\0\0"
    "stopNightJob"
};
...
void RequestManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RequestManager *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->startNightJob(); break;
        case 1: _t->stopNightJob(); break;
        default: ;
        }
    }
    (void)_a;
...
QT_INIT_METAOBJECT const QMetaObject RequestManager::staticMetaObject = { {
    ...
    qt_meta_stringdata_RequestManager.data,
    qt_meta_data_RequestManager,
    qt_static_metacall,
    nullptr,
    nullptr
} };
